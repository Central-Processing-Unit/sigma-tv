        ...
        <Flex>
          <FormControl isRequired mt="5px" pr="5px">
            ...
            <Input
              ...
              onChange={e =>
                setTeams(t => ({...t, blueTeamOne: e.target.value}))
              }
              placeholder="20323"
            />
          </FormControl>
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setTeams(t => ({...t, blueTeamTwo: e.target.value}))
              }
              placeholder="13092"
            />
          </FormControl>
        ...
        <Flex>
          <FormControl isRequired mt="5px" pr="5px">
            ...
            <Input
              ...
              onChange={e =>
                setTeams(t => ({...t, redTeamOne: e.target.value}))
              }
              placeholder="20323"
            />
          </FormControl>
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setTeams(t => ({...t, redTeamTwo: e.target.value}))
              }
              placeholder="13092"
            />
          </FormControl>
        ...
        <Flex>
          ...
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setBlueScore(s => ({...s, autonomous: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
        ...
        <Flex>
          <FormControl isRequired mt="5px" pr="5px">
            ...
            <Input
              ...
              onChange={e =>
                setBlueScore(s => ({...s, driver: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setBlueScore(s => ({...s, endGame: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
        ...
        <Flex>
          ...
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setRedScore(s => ({...s, autonomous: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
        ...
        <Flex>
          ...
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setRedScore(s => ({...s, endGame: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
        ...
        <Flex>
          <FormControl isRequired mt="5px" pr="5px">
            ...
            <Input
              ...
              onChange={e =>
                setBlueScore(s => ({...s, penalty: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
          <FormControl isRequired mt="5px" pl="5px">
            ...
            <Input
              ...
              onChange={e =>
                setRedScore(s => ({...s, penalty: e.target.value}))
              }
              placeholder="0"
            />
          </FormControl>
